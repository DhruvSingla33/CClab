...
export default function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const passwordBoolean = formData.password === '1234'; // Check if password is '1234'
      const userData = { ...data, passwordBoolean };
  ...
  <div style={{ padding: '2rem', maxWidth: '600px',width:'500px', margin: '10px', backgroundColor: '#F5EFE6', borderRadius: '8px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)' }}>
